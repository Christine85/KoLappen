...
namespace KoLappen.Models
{
    public class TestProfileDM : IProfileRepository
    {
        ...
        //static List<Location> jobAeas = new List<Location>();
        //static List<UserJobLocation> userJobAreas = new List<UserJobLocation>();
        ...
        ProfileVM IProfileRepository.GetProfile(string userName)
        {
            throw new NotImplementedException();
        }
    }
